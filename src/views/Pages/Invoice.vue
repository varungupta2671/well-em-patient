...
export default {
  ...
  data () {
    return {
      image: require('../../assets/images/well-em-logo.png'),
      title: 'Invoice',
      invoice: {
        ...
        order: [
          {
            ...
            orderStatus: 2,
            orderID: '250028',
            billingAddress: 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia <br> Phone: +123 456 7890 <br> Email: demo@wellem.com <br> Web: www.wellem.com',
            shippingAddress: 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia <br> Phone: +123 456 7890 <br> Email: demo@wellem.com <br> Web: www.wellem.com'
          }
        ],
        orderSummaryFields: [
          {
